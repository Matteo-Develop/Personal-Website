...
The Contact section leads with **"Recruiting for Summer 2027"**. That is
deliberately dated and it is the one line on the site with an expiry — change
it in `index.html` when the cycle turns, and re-run the prerender.
